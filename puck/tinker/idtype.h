 ...
 * 1) We want to preserve alignment (extra padding in the Object may be needed (see the comment in nmslib_object.h).
...
const size_t ID_SIZE         = 0;
//const size_t LABEL_SIZE      = sizeof(LabelType);
const size_t LABEL_SIZE      = 0;
