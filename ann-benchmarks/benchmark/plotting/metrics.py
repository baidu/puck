...
def build_memory(attrs):
    """get the memory used during buider(max)"""
    return attrs.get("build_memory", 0) / 1024 / 1024
...
all_metrics = {
    ...
    "buildmemory": {
        ...
        "function": lambda true_nn, run_nn, metrics, run_attrs: build_memory(run_attrs),  # noqa
        "worst": float("inf")
    },
    "queriessize": {
